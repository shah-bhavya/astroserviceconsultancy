...
<head>
    <title>Astrology Service Consultancy - Instant solution of any problem of life  in India & all over World.</title>
    <meta charset="utf-8">
    ...
    <style>
        ...
        @media(max-width:500px) {
            .ast_slider_wrapper {
                ...
                z-index: 1;
                background-image: url('Default/images/cool-galaxy-wallpaper-004_mobile.jpg');
...
<body>
    ...
    <div class="ast_top_header" style="background-image: linear-gradient(to right, #000000, #0e2223, #12314d);padding: 5px;">
        <div class="container">
 <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <marquee style="font-size:16px"><span style="color:#fff;">गेट योर लव बैक,</span> <span style="color:#f7b70b;">लव मैरिज प्रॉब्लम सोल्यूशन,</span><span style="color:#fff;"> टीनेज लव,<span style="color:#f7b70b;"> रिलेशनशिप प्रॉब्लम,</span></span>
<span style="color:#fff;">फॅमिली प्रॉब्लम,</span> <span style="color:#f7b70b;">हस्बैंड वाइफ प्रॉब्लम सोलुशन</span></marquee>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <div class="ast_logo">
                            <a href="index.php"><img src="Default/images/header/logo.png" alt="Logo" title="The  Astrology Consultancy Service"></a>
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                        <div class="ast_main_menu_wrapper">
                            <div class="ast_menu navigation">
                                <ul>
                                    <li>
                                        <a class="active" href="#Home" title="Astro Service Consultancy">HOME</a>
                                        <!--<ul class="submenu">
                                            <li><a href="Default/index.html">home</a></li>

                                        </ul>-->
                                    </li>
                                    <li><a href="#AboutUs" title="About Astrology">ABOUT</a></li>
                                    <li><a href="#Services" title="Service we provides">SERVICES</a></li>
                                    <li><a href="#works" title="Works we do">WORKS</a></li>
                                    <li><a href="#ContactUs" title="Contact Us">CONTACT</a></li>
                                    <li><a href="tel:7434804490" title="Call Us"><i class="fa fa-phone"></i>&nbsp;&nbsp;7434804490</a></li>
                                    <li>
                                        <a href="https://api.whatsapp.com/send?phone=+917434804490&text=Hello , I am Deepak How can i help you !!" title="You can Contact Us from whatsapp"><img src="Default\images\whatsapp.png" class="bounce"></img></a>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="ast_blog_box">
                                <div class="ast_blog_img">
                                    ...
                                    <a><img src="Default/images/Astrology.jpg" class="fix-height-width" alt="Astrology" title="Astrology"></a>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="ast_blog_box">
                                <div class="ast_blog_img">
                                    <span class="ast_date_tag" style="color:white!important;">Love Marriage Problem</span>
                                    <a><img src="Default/images/Love Marriage.jpg" class="fix-height-width" alt="Love Marriage Problem" title="Love Marriage"></a>
                                </div>
                                <div class="ast_blog_info">
                                    <ul class="ast_blog_info_text">
                                        <li><a class="bold"><i class="fa fa-comments-o" aria-hidden="true"></i> Love Marriage Problem</a></li>
                                    </ul>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="ast_blog_box">
                                <div class="ast_blog_img">
                                    ...
                                    <a><img src="Default/images/family problems.jpg" class="fix-height-width" alt="Family Problem" title="Family Problem"></a>
                                </div>
                                <div class="ast_blog_info">
                                    <ul class="ast_blog_info_text">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="ast_blog_box">
                                <div class="ast_blog_img">
                                    ...
                                    <a><img src="Default/images/Intercast_marriage.jpg" class="fix-height-width" alt="Intercast Marriage" title="Intercast Marriage"></a>
                                </div>
                                <div class="ast_blog_info">
                                    <ul class="ast_blog_info_text">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="ast_blog_box">
                                <div class="ast_blog_img">
                                    ...
                                    <a><img src="Default/images/Relationship problem.png" class="fix-height-width" alt="Relation Problem" title="Relation Problem"></a>
                                </div>
                                <div class="ast_blog_info">
                                    <ul class="ast_blog_info_text">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="ast_blog_box">
                                <div class="ast_blog_img">
                                    ...
                                    <a><img src="Default/images/business problem.jpg" class="fix-height-width" alt="Business Problem" title="Business Problem"></a>
                                </div>
                                <div class="ast_blog_info">
                                    <ul class="ast_blog_info_text">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="ast_blog_box">
                                <div class="ast_blog_img">
                                    ...
                                    <a><img src="Default/images/child problem.jpg" class="fix-height-width" alt="Child Problem" title="Child Problem"></a>
                                </div>
                                <div class="ast_blog_info">
                                    <ul class="ast_blog_info_text">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="ast_blog_box">
                                <div class="ast_blog_img">
                                    ...
                                    <a><img src="Default/images/court case.jpg" class="fix-height-width" alt="Court Case Problem" title="Court Case Problem"></a>
                                </div>
                                <div class="ast_blog_info">
                                    <ul class="ast_blog_info_text">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="ast_blog_box">
                                <div class="ast_blog_img">
                                    ...
                                    <a><img src="Default/images/Love issue.jpg" class="fix-height-width" alt="Love Issue" title="Love Issue"></a>
                                </div>
                                <div class="ast_blog_info">
                                    <ul class="ast_blog_info_text">
    ...
    <div class="ast_contact_wrapper ast_toppadder70 ast_bottompadder50" id="ContactUs">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="ast_contact_info">
                        <a href="https://api.whatsapp.com/send?phone=+917434804490&text=Hello,I am Deepak How can i help you !!"><span><i class="fa fa-whatsapp" aria-hidden="true"></i></span></a>
                        <h4>whatsapp</h4>
                        <p><a href="https://api.whatsapp.com/send?phone=+917434804490&text=Hello,I am Deepak How can i help you !!">+91 74348 04490</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="ast_mapnform_wrapper ast_toppadder70" style="padding-bottom:80px">
        ...
        <div class="col-lg-6 col-md-8 col-sm-8 col-xs-12 col-lg-offset-3 col-md-offset-2 col-sm-offset-2 col-xs-offset-0">
            <div class="ast_contact_form_custom" id="focus">
                <div class="row">
                    <div class="col-md-12">
                        <?php
                        ...
                        $mail->IsHTML(true);
                        $mail->Username = "info@astroserviceconsultancy.com";
                        $mail->Password = "@WebEmail_2018";
                        $mail->SetFrom("info@astroserviceconsultancy.com");
                        if (empty($_POST["name"])) {
  ...
  echo '}, 1000);</script>';
                        ...
                        $mail->AddAddress("info@astroserviceconsultancy.com");
                        if(!$mail->Send())
                        {
                        echo "<table>
                            <tr>
                        ...
                        {
                        echo '<script type="text/javascript">';
  echo 'setTimeout(function () { swal("Message has been sent successfully!","Message sent to info@astroserviceconsultancy.com!","success");';
  echo '}, 1000);</script>';
                        }
                ...
                <form method="post">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <label><sapn style="color:red">*</sapn> Name</label>
                        <input type="text" name="name" class="require" placeholder="Enter Name">
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <label><sapn style="color:red">*</sapn> Mobile No</label>
                        <input type="text" name="phone" class="require" data-valid="phone" placeholder="Enter Your Mobile No" data-error="mobile no should be valid.">
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <label>Subject</label>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <label><sapn style="color:red">*</sapn> Message</label>
    ...
    <div class="ast_footer_wrapper ast_toppadder70 ast_bottompadder20">
        <div class="container">
            <div class="ast_copyright_wrapper_custom">
                <div class="row ">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:20px; text-align: center">
                        <h4>&copy; Copyright 2019, All Rights Reserved, <a href="#">astroserviceconsultancy.com</a></h4>
                    </div>
                    <div class="col-md-1"></div>
                    <!--<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12" style="padding-top:20px;">
                        <h4 style="text-align:right">Developed & Maintained By <a >BHAVYA M. SHAH</a></h4>
                    </div>-->
                </div>
            </div>
        </div>
 ...
 .add({
  ...
  text: "Message has been delivered to info@astroserviceconsultancy.com!",
  icon: "success",
  button: "Ok",
        });    	
    </script>
